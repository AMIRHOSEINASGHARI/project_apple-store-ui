...
const ProductCard = ({ image, colors, title, price }: ProductCardProps) => {
  return (
    <div className="bg-lightGray rounded-[10px] p-3 flex flex-col justify-between gap-5 h-[400px] 2xl:h-[541px]">
